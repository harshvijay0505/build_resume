...
export default function CustomizedAccordions() {
  ...
  let removeHandler = (e) => {
    ...
    setArr(arr.filter(items => items.Eid !== data));
  }
              ...
              <Accordion style={{ margintop: '10px' }}>
                <AccordionSummary>
                  <div className="titlefloatleft">
                    <Typography><b>{data.institute}</b></Typography>
                  </div>
                ...
                <AccordionDetails>
                  ...
                  <Typography style={{ marginLeft: '3.5%', wordWrap: "break-word" }}>{data.degree}</Typography>
                  <Typography style={{ marginLeft: '3.5%', marginTop: '2%', color: 'grey', fontSize: 'small', wordWrap: "break-word" }}><b>Description</b></Typography>

                  <Typography style={{ marginLeft: '3.5%', marginRight: '3.5%', wordWrap: "break-word" }}>{data.desc}</Typography>
                </AccordionDetails>
                ...
                <Button removeelement={data.Eid} onClick={removeHandler} variant="outlined" style={{ textTransform: 'none', marginBottom: '10px', marginTop: '10px', marginLeft: '10px' }}>Delete</Button>
                  ...
                  <Dialog open={edits} onClose={handleClose} style={{ width: '100%' }}>
                    ...
                    <DialogActions>
                      <Button
                        ...
                        onClick={() => {
                          setEdits(false)
                          updateUserEdu(ins, deg, str, end, des, Eid)
                        }}
                      >
                        Save
                      </Button>
